    ...
    <div className="relative w-full p-10 overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center flex-col space-y-10">
        ...
        <div className="text-center space-y-4 ">
          ...
          <p className="text-2xl text-[hsl(245,15%,58%)]">secure your spot at next year's biggest coding conference. </p>
        </div>
        <div className="w-[400px]  justify-start">
          <p className=" text-[hsl(245,15%,58%)] ">Upload your avatar</p>
